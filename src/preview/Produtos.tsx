...
const COLUNAS = ["Produto", "Valor", "Estoque", "Situação", "Ações"];
...
const LINHAS: PreviewRow[] = [
  {
    ...
    photo: "",
    kind: "objeto",
    main: ["Tag de acesso veicular", "Reposição para moradores"],
    cols: ["R$ 45,00", "28 unidades"],
  ...
  },
  {
    ...
    photo: "",
    kind: "objeto",
    main: ["Controle remoto do portão", "Duas teclas"],
    cols: ["R$ 90,00", "12 unidades"],
    badge: ["Disponível", "green"],
    actions: ["Editar", "Histórico"],
  },
  {
    ...
    photo: "",
    kind: "objeto",
    main: ["Cartão de proximidade", "Visitante recorrente"],
    cols: ["R$ 18,00", "64 unidades"],
    badge: ["Disponível", "green"],
    actions: ["Editar", "Histórico"],
  },
  {
    ...
    photo: "",
    kind: "objeto",
    main: ["Chave da lavanderia", "Cópia autorizada"],
    cols: ["R$ 25,00", "3 unidades"],
    badge: ["Estoque baixo", "amber"],
    actions: ["Editar", "Histórico"],
  },
  {
    tab: "history",
    photo: "",
    kind: "objeto",
    main: ["Adesivo veicular antigo", "Descontinuado em 06/2026"],
    cols: ["R$ 12,00", "0 unidade"],
    badge: ["Esgotado", "gray"],
    actions: ["Histórico"],
  },
];
...
export default function Produtos() {
  ...
  return (
    <main className="op-main">
      ...
      <section className="op-panel" aria-label="Lista de produtos">
      ...
      {form && (
        <Modal title="Novo produto" onClose={() => setForm(false)}>
          <form
            className="op-form"
            onSubmit={(e) => {
              e.preventDefault();
          ...
          >
            ...
            <div className="op-form-grid">
              ...
              <Field label="Valor" name="valor" />
              <Field label="Estoque" name="estoque" />
            </div>
